      ...
      <div class="hstui-frame-content">
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('username')) hstui-form-error @endif" id="J_form_error_username">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="username" id="lzscms_username" value="{{ lzs_value('username') }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('password')) hstui-form-error @endif" id="J_form_error_password">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="password" id="lzscms_password" value="{{ lzs_value('password') }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('mobile')) hstui-form-error @endif" id="J_form_error_mobile">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="mobile" id="lzscms_mobile" value="{{ lzs_value('mobile') }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('email')) hstui-form-error @endif" id="J_form_error_email">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="email" id="lzscms_email" value="{{ lzs_value('email') }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('qq')) hstui-form-error @endif" id="J_form_error_qq">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="qq" id="lzscms_qq" value="{{ lzs_value('qq') }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('weixin')) hstui-form-error @endif" id="J_form_error_weixin">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="weixin" id="lzscms_weixin" value="{{ lzs_value('email') }}" class="hstui-input hstui-length-4">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('status')) hstui-form-error @endif" id="J_form_error_status">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
            <input type="checkbox" name="status" id="lzscms_status" data-class="hstui-switchx-default hstui-round hstui-mr-lg" data-switchx-offtext="{{ lzs_lang('lzscms::public.disable')}}" data-switchx-ontext="{{ lzs_lang('lzscms::public.enable')}}" data-hstui-switchx checked data-switchx-text="status"/>
