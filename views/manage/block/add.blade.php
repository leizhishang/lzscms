    ...
    <div class="hstui-frame">
      <div class="hstui-frame-content">
        ...
        <div class="hstui-form-group hstui-form-group-sm hstui-hide @if($errors->has('link')) hstui-form-error @endif" id="J_form_error_link">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="link" id="lzscms_link" value="{{ lzs_value('link') }}" class="hstui-input hstui-length-6">
        ...
        <div class="hstui-form-group hstui-form-group-sm hstui-hide @if($errors->has('contentv')) hstui-form-error @endif" id="J_form_error_contentv">
          <label class="hstui-u-sm-2 hstui-form-label">{{ lzs_lang('lzscms::public.content') }}</label>
          <div class="hstui-u-sm-10 hstui-form-input">
              <textarea class="hstui-textarea" style="height: 420px; width: 100%;" name="contentv" id="lzscms_contentv"></textarea>
          </div>
        </div>
      </div>
    </div>
