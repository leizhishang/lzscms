...
<div class="manage-content">
  ...
  <form class="hstui-form hstui-form-horizontal J_ajaxForm" action="{{ route('manageFieldsEditSave') }}" method="post">
    ...
    <input type="hidden" name="relatedtable" value="{{ $info['relatedtable'] }}">
    <div class="hstui-frame">
      <div class="hstui-frame-content">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('fieldname')) hstui-form-error @endif" id="J_form_error_fieldname">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="fieldname" id="lzscms_fieldname" value="{{ lzs_value('fieldname', $info) }}" readonly class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('vieworder')) hstui-form-error @endif" id="J_form_error_vieworder">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="vieworder" id="lzscms_vieworder" value="{{ lzs_value('vieworder', $info) }}" class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('disabled')) hstui-form-error @endif" id="J_form_error_disabled">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="checkbox" name="disabled" id="lzscms_disabled" data-class="hstui-switchx-default hstui-round hstui-fl hstui-mr-sm" data-switchx-offtext="{{ lzs_lang('lzscms::public.closes')}}" data-switchx-ontext="{{ lzs_lang('lzscms::public.opens')}}" data-hstui-switchx @if(old('disabled')) {{ lzs_ifCheck(old('disabled')) }} @else {{ lzs_ifCheck(!lzs_value('disabled', $info)) }} @endif data-switchx-text="disabled"/>
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('fieldtype')) hstui-form-error @endif" id="J_form_error_fieldtype">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <select class="hstui-input hstui-select" disabled readonly name="fieldtype" id="lzscms_fieldtype">
                <option value="">{{ lzs_lang('lzscms::public.please.select') }}</option>
                @foreach($fieldTypes as $fieldType)
                <option value="{{ $fieldType['id'] }}" {{ lzs_isSelected($info['fieldtype'] == $fieldType['id']) }}>{{ $fieldType['name'] }}</option>
                @endforeach
              </select>
      ...
      <div class="hstui-frame-content">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('isrequired')) hstui-form-error @endif" id="J_form_error_isrequired">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <label><input type="radio" value="0" onClick="set_required(0)" name="setting[validate][required]" {{ lzs_ifCheck(!lzs_value('required', $info['setting']['validate'])) }}><span>{{ lzs_lang('lzscms::public.no') }}</span></label>
              <label><input type="radio" value="1" onClick="set_required(1)" name="setting[validate][required]" {{ lzs_ifCheck(lzs_value('required', $info['setting']['validate'])) }}><span>{{ lzs_lang('lzscms::public.yes') }}</span></label>
        ...
        <div id="required" class="hstui-form-group hstui-form-group-sm" @if(!$info['setting']['validate']['required'])style="display: none;" @endif >
          <div class="hstui-form-group hstui-form-group-sm" id="J_form_error_pattern">
            ...
            <div class="hstui-u-sm-10 hstui-form-input">
                <input type="text" name="setting[validate][pattern]" id="lzscms_pattern" value="{{ lzs_value('pattern', $info['setting']['validate']) }}" class="hstui-input hstui-length-3">
          ...
          <div class="hstui-form-group hstui-form-group-sm" id="J_form_error_errortips">
            ...
            <div class="hstui-u-sm-10 hstui-form-input">
                <input type="text" name="setting[validate][errortips]" id="lzscms_errortips" value="{{ lzs_value('errortips', $info['setting']['validate']) }}" class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm" id="J_form_error_v_tips">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="setting[validate][tips]" id="lzscms_v_tips" value="{{ lzs_value('tips', $info['setting']['validate']) }}" class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('isedit')) hstui-form-error @endif" id="J_form_error_isedit">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="checkbox" name="isedit" id="lzscms_isedit" data-class="hstui-switchx-default hstui-round hstui-fl hstui-mr-sm" data-switchx-offtext="{{ lzs_lang('lzscms::public.no')}}" data-switchx-ontext="{{ lzs_lang('lzscms::public.yes')}}" data-hstui-switchx @if(old('isedit')){{ lzs_ifCheck(old('isedit')) }}@else {{ lzs_ifCheck(lzs_value('isedit', $info['setting']['validate'])) }} @endif data-switchx-text="isedit"/>
      ...
      <div class="hstui-frame-content">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('ismshow')) hstui-form-error @endif" id="J_form_error_ismshow">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="checkbox" name="ismshow" id="lzscms_ismshow" data-class="hstui-switchx-default hstui-round hstui-fl hstui-mr-sm" data-switchx-offtext="{{ lzs_lang('lzscms::public.no')}}" data-switchx-ontext="{{ lzs_lang('lzscms::public.yes')}}" data-hstui-switchx @if(old('ismshow')) {{ Lzs_ifCheck(old('ismshow')) }} @else {{ Lzs_ifCheck(lzs_value('ismshow', $info)) }}  @endif data-switchx-text="ismshow"/>
