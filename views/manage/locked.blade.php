  ...
  <div class="login-page">
    <div class="login-form">
      ...
      {!! lzs_csrf() !!}
        ...
        <button type="submit" class="hstui-button hstui-button-primary hstui-button-block" data-button-content="{{ lzs_lang('lzscms::public.unlocked.loading') }}">{{ lzs_lang('lzscms::public.unlocked') }}</button>
        @if (count($errors) > 0)
