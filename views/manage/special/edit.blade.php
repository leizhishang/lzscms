    ...
    <div class="hstui-frame">
      <div class="hstui-frame-content">
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('name')) hstui-form-error @endif" id="J_form_error_name">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input onBlur="Lzs_topinyin('dir', 'name');" type="text" name="name" id="lzscms_name" value="{{ lzs_value('name', $info) }}" class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('dir')) hstui-form-error @endif" id="J_form_error_dir">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <input type="text" name="dir" id="lzscms_dir" value="{{ lzs_value('dir', $info) }}" class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('domain')) hstui-form-error @endif" id="J_form_error_domain">
          ...
          <div class="hstui-u-sm-10  hstui-form-input">
              <input type="text" name="domain" id="lzscms_domain" value="{{ lzs_value('domain', $info) }}" class="hstui-input hstui-length-5">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('style')) hstui-form-error @endif" id="J_form_error_style">
          ...
          <div class="hstui-u-sm-10  hstui-form-input">
              <input type="text" name="style" id="lzscms_style" value="{{ lzs_value('style', $info) }}" class="hstui-input hstui-length-5">
      ...
      <div class="hstui-frame-content">
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('title')) hstui-form-error @endif" id="J_form_error_title">
          ...
          <div class="hstui-u-sm-10  hstui-form-input">
              <input type="text" name="title" id="lzscms_title" value="{{ lzs_value('title', $info) }}" class="hstui-input hstui-length-6">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('keywords')) hstui-form-error @endif" id="J_form_error_keywords">
          ...
          <div class="hstui-u-sm-10  hstui-form-input">
              <input type="text" name="keywords" id="lzscms_keywords" value="{{ lzs_value('keywords', $info) }}" class="hstui-input hstui-length-6">
        ...
        <div class="hstui-form-group hstui-form-group-sm @if($errors->has('description')) hstui-form-error @endif" id="J_form_error_description">
          ...
          <div class="hstui-u-sm-10 hstui-form-input">
              <textarea class="hstui-input hstui-textarea hstui-length-6" style="height: 120px;" name="description" id="lzscms_description">{{ lzs_value('description', $info) }}</textarea>
