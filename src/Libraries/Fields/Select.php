...
class Select extends FieldAbs {
    ...
    {
		parent::__construct();
		$this->name = lzs_lang('lzscms::fields.select'); // 字段名称
		...
		return '
			<div class="hstui-form-group hstui-form-group-sm">
	          ...
	          <div class="hstui-u-sm-10 hstui-form-input">
	            ...
	            <div class="hstui-form-input-tips" id="J_form_tips_name">'.lzs_lang('lzscms::fields.select.list.tips').'</div>
	          </div>
	        </div>
	...
	public function input($cname, $name, $cfg, $value = NULL, $id = 0) 
	{
		...
		$str = '<select '.$disabled.' name="'.$name.'" id="Lzscms_'.$name.'" class="hstui-select" '.$attr.' >';
		if ($options) {
