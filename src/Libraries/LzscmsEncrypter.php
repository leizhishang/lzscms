...
class LzscmsEncrypter implements EncrypterContract
{
    /**
     * The encryption key.
     *
    ...
    public function decrypt($payload, $unserialize = false)
    {
        ...
        if ($decrypted === false) {
            ...
            return lzs_message('Could not decrypt the data.', 'error');
        }
        if(isset($payload['sl'])) {
    ...
    protected function getJsonPayload($payload)
    {
        ...
        if (! $this->validMac($payload)) {
            ...
            return lzs_message('The MAC is invalid.', 'error');
        }
