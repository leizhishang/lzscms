 ...
 */
namespace Leizhishang\Lzscms\Helpers;
...
trait WebResponse
{
     ...
     * @param return null
     */
    public function addMessage($message = array(), $str = '')
    {
        if(!$str) return;
    ...
    public function showMessage($message = '', $routeName = '', $with = 0, $state='success') 
    {
        ...
        if($this->isMobile) {
            return $this->loadTemplate('lzscms::wap.tips', $viewData);
        }
        return $this->loadTemplate('lzscms::common.tips', $viewData);
    }
